...
extern "C" void set_write_back(const svOpenArrayHandle r) {
  write_back = (bool *)(((VerilatedDpiOpenVar *)r)->datap());
}

extern "C" void set_done(const svOpenArrayHandle r) {
  done = (bool *)(((VerilatedDpiOpenVar *)r)->datap());
}
